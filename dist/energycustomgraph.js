...
${this._renderTimespanSection(e)}
    ...
    `}_setTermMode(e,t,i){this._mutateTerm(e,t,e=>{"statistic"===i?(e.constant=void 0,e.statistic_id||(e.statistic_id=""),e.stat_type||(e.stat_type="change")):(e.statistic_id=void 0,e.stat_type=void 0,e.multiply=void 0,e.add=void 0,e.clip_min=void 0,e.clip_max=void 0,void 0===e.constant&&(e.constant=0))})}_renderSeriesDisplayGroup(e,t){let i=e.chart_type??"bar",s="line"===i||"step"===i,r=s&&!0===e.fill,a=r&&!0===e.gradient_fill,n="string"==typeof e.color?e.color.trim():void 0,l=this._extractPresetToken(n),d=n?l||x:$,h=this._colorModeSelections.get(t)??d,u=this._customColorDrafts.get(t),p=this._resolveAutoColorToken(t),_=h===x?u??n??"":u??"",g=h===$?p:h===x?_||n||p:h,f=void 0!==g?this._normalizeColorToken(g):void 0,v=h===x?_??"":"",y="string"==typeof e.compare_color?e.compare_color.trim():void 0,b=this._extractPresetToken(y),S=y?b||x:C,w=this._compareColorModeSelections.get(t)??S,A=this._compareCustomColorDrafts.get(t),T=w===x?A??y??"":A??"",E=w===C?g:w===x?A??y??"":w,M=void 0!==E?this._normalizeColorToken(E):void 0;return(0,o.html)`
      <div class="group-card">
        <div class="group-header">
