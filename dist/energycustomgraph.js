...
${this._renderTimespanSection(e)}
    ...
    `}_setTermMode(e,t,i){this._mutateTerm(e,t,e=>{"statistic"===i?(e.constant=void 0,e.statistic_id||(e.statistic_id=""),e.stat_type||(e.stat_type="change")):(e.statistic_id=void 0,e.stat_type=void 0,e.multiply=void 0,e.add=void 0,e.clip_min=void 0,e.clip_max=void 0,void 0===e.constant&&(e.constant=0))})}_renderSeriesDisplayGroup(e,t){let i=e.chart_type??"bar",s="line"===i||"step"===i,r=s&&!0===e.fill,a="string"==typeof e.color?e.color.trim():void 0,n=this._extractPresetToken(a),l=a?n||C:w,d=this._colorModeSelections.get(t)??l,c=this._customColorDrafts.get(t),u=this._resolveAutoColorToken(t),p=d===C?c??a??"":c??"",_=d===w?u:d===C?p||a||u:d,g=void 0!==_?this._normalizeColorToken(_):void 0,f=d===C?p??"":"",v="string"==typeof e.compare_color?e.compare_color.trim():void 0,y=this._extractPresetToken(v),b=v?y||C:x,S=this._compareColorModeSelections.get(t)??b,$=this._compareCustomColorDrafts.get(t),A=S===C?$??v??"":$??"",T=S===x?_:S===C?$??v??"":S,E=void 0!==T?this._normalizeColorToken(T):void 0;return(0,o.html)`
      <div class="group-card">
        <div class="group-header">
